            ...
            <div class="box" style="height: 400px;">
                ...
                ?>
                    ...
                    <div class="low_container">
                        ...
                        <!-- Edit Profile Button -->
                        <form method="POST">
                            <button class="button exempt-hover" style="margin-right: 50px; margin-top: 10px; margin: 0 auto; background-color: rgb(2, 24, 153);" name="submit"><a href="editprof.php" class="a-exempt" style="color: white;">EDIT</a></button>
                        </form>
                    </div>
            </div>
    </div>
