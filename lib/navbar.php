            ...
            ?>
                ...
                <div class="row1">
                    ...
                    <div id="mySidenav" class="sidenav">
                        ...
                        <a href="home.php" class="a-exempt">HOME</a> <br id="hidebr1">
                        <a href="profile.php" class="a-exempt">PROFILE</a> <br id="hidebr1">
                        <a href="uploader.php" class="a-exempt">BOOK UPLOADS</a> <br id="hidebr1">
                        <a href="student.php" class="a-exempt">STUDENT LIST</a> <br id="hidebr1">
                        <a href="book.php" class="a-exempt">BOOKS</a> <br id="hidebr1">
                        <a href="request.php" class="a-exempt">BOOK REQUESTS</a> <br id="hidebr1">
                        <a href="issue_info.php" class="a-exempt">ISSUED BOOKS INFORMATION </a> <br id="hidebr1">
                        <a href="logout.php" class="a-exempt">LOG-OUT</a> <br id="hidebr1">
                        ...
                        <div class="exempt-hover" id="log_box">
                            <li style="display: inline; word-spacing: 1px;">
                                <a href="profile.php" style="padding: 8px; color: white; display: flex; text-align: center; align-items: center">
                                    ...
                                    <?php
                                    // Librarian Query
                                    $q = mysqli_query($db, "SELECT * FROM `lib` where email = '$ses_email';");
